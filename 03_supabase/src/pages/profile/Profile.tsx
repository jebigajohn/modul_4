...
export default function Profile() {
  ...
  // getUser fragt den aktuellen eigeloggten User aus der gespeicherten Session im Browser ab
  // gibt es eine gültige Session im LocalStorage?
  // wenn Ja dann gib mir die ID von dem User
  // Wenn nein dann sollte User null sein
